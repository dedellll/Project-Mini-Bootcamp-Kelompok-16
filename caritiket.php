        ...
        <div class="col-md-3">
               <div class="form-group">
                <label>Dermaga Keberangkatan</label>
                  <i class="fa fa-ship"></i>
                   ...
                   <option value="Sanur Bay" <?php  if ($dermaga == "Tanjungpinang"){ echo "selected"; } ?>>Tanjungpinang</option>
                   <option value="Gili Bay" <?php if ($dermaga == "Batam"){ echo "selected"; } ?>>Batam</option>
                   <option value="Gili Bay" <?php if ($dermaga == "Natuna"){ echo "selected"; } ?>>Natuna</option>
                </select>
               </div>
               </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <option value="-"> -Choose- </option>
                    <option value="Gili Terawangan" <?php if ($rute=="Tanjungpinang"){ echo "selected"; } ?>>Tanjungpinang</option>
                    <option value="Nusa Penida" <?php if ($rute=="Batam"){ echo "selected"; } ?>>Batam</option>
                    <option value="Gili Bay" <?php if ($rute == "Natuna"){ echo "selected"; } ?>>Natuna</option>
                </select>
                </div>
            </div>
